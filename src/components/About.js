  ...
  return (
    <>
      ...
      <div className='flex flex-col h-full justify-center'>
        <h3 className='text-5xl md:text-6xl font-bold'>About the Course</h3>
        ...
        <button type="button" class="text-white bg-[#0d4332]  focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#1da1f2]/55 mr-2 mb-2">
  Explore Now
</button>
        </div>
      </div>
